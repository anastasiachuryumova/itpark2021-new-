package lesson34.service.impl;

import lesson34.dto.GenreDto;
import lesson34.dto.GenrePageDto;
import lesson34.mapper.GenreMapper;
import lesson34.model.Genre;
import lesson34.repository.GenreRepository;
...
public class GenreServiceImpl implements GenreService {
    ...
    public GenreDto save (@Valid GenreDto genre) {
        return genreMapper.toDo(genreRepository.save(genreMapper.toEntity(genre)));
    }
