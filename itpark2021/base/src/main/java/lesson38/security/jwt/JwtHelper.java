...
public class JwtHelper {
    ...
    public JwtHelper() throws JOSEException {
        this.jwtSigner = new MACSigner("theStrongestPasswordAllOverTheWord");
        this.jwsVerifier = new MACVerifier("theStrongestPasswordAllOverTheWord");
    }

    @SneakyThrows
    public String generateToken(String issuer, String login, String[] rights) {
        Pair<Date, Date> issueAndExpirationTimes = getTissueAndExpirationTimes();
    ...
    private Pair<Date, Date> getTissueAndExpirationTimes() {
